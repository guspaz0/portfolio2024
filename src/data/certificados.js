...
export default {
    data: [
        ...
        { id: 5, nombre: 'Docker Fundamentos', escuela: 4, path: '', fecha: new Date(), aptitudes: [18]},
        { id: 6, nombre: 'Serverless framework avanzado con AWS', escuela: 4, path: '', fecha: new Date(), aptitudes: [20,21]},
        { id: 6, nombre: 'Cloud computing y machine learning en la nube con AWS', escuela: 4, path: '', fecha: new Date(), aptitudes: [21]}
    ],
    findAll: function (){
