...
export default {
    data: [
        ...
        { id: 8, nombre: 'Aprende todo sobre Looker Studio 2024 (Data Studio)', escuela: 3, path: 'udemy_looker_studio_bbzzjy.jpg', fecha: new Date(2024,3,15), aptitudes: [29]},
        { id: 9, nombre: 'Excel y Power BI - Análisis y Visualizacion de Datos', escuela: 3, path: 'udemy_powerbi_mu1c2e.jpg', fecha: new Date(2024,9,8), aptitudes: [22,28]},
        ...
        { id: 11, nombre: 'Microsoft Power Bi Desktop', escuela: 3, path: 'UC_Power_Bi_Desktop_ouylap.jpg', fecha: new Date(2024,10,4), aptitudes: [28]},
        { id: 12, nombre: 'Power Query', escuela: 3, path: 'UC-power_query_hfh5gf.jpg', fecha: new Date(2024,10,5), aptitudes: [22,28]}
    ],
    findAll: function (){
